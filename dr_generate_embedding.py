...
# 输入JSON文件路径和输出文件路径
PATH_TO_PROMPTS = r"/home/chenlb/CuPL/dr/DR_prompt_result.json"
OUTPUT_FILE_PATH = "/home/chenlb/CuPL/dr/dr_embedding_results.json"
...
for key in gpt3_prompts:
    gpt3_prompts[key] = remove_duplicates(gpt3_prompts[key])
